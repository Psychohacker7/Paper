...
The temporal test set also validates generalization to novel experimental conditions. Structures deposited in 2023--2024 include receptors determined using the latest cryo-EM methods, novel ligand chemotypes such as non-peptide GLP-1 receptor agonists\autocite{Kawai2025}, and signaling complexes with previously uncharacterized transducers. The robust performance on these structures suggests that \hyaline{} has learned the fundamental physics of activation rather than method-specific or ligand-specific correlates.
