...
\begin{tikzpicture}
    ...
    \node[font=\scriptsize\bfseries] at ($(rbf-caption) + (0.2, 1.05, 0)$) {RBF};
    ...
    \node[font=\scriptsize\bfseries] at ($(edgeupd-caption) + (0.15, 1, 0)$) {Edge Update};
    ...
    \node[font=\scriptsize\bfseries] at ($(nodeupd-caption) + (0.2, 1.1, 0)$) {Node Update};
    ...
    \node[font=\sffamily\scriptsize, text=gray, anchor=west] at (0, -8.5) {
        \textbf{---} main flow \quad \textbf{$\cdots$} residual \quad \textcolor{orange!70}{\textbf{- -} }\textcolor{orange!70}{feature injection}
    };
